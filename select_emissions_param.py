...
#################################################
################ USER PARAMETERS ################
res_folder = './results/'  # name for the results folder

#  NB: le province selezionate DEVONO essere adiacenti. e.g. [Ferrara, Bologna, Modena] è una buona selezione, [Ferrara, Bologna, Parma] invece NO

# UNCOMMENT ONLY THE PARAMETERS RELATED TO A PROVINCE THAT MUST BE ANALYSED
...
# prov_numname=[(0,'Meuse'),(0,'Bas-Rhin'),(0,'Vosges'),
#               (0,'Marne'),(0,'Meurhe-et-Moselle'),
...
d_lat = 0.1
earth_rad = 6371 # [km]
j_stat, i_stat = net.lat_to_index(lat_stat, lon_stat)
lat_stat_stat = net.index_to_lat(j_stat, i_stat) # obtain approximated lat_stat, lon_stat cendered on grid points 
